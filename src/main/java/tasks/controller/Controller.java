...
public class Controller {
    ...
    public void showTaskDialog(ActionEvent actionEvent){
        ...
        AddEditTaskController.setClickedButton((Button) source);

        try {
            editNewStage = new Stage();
            AddEditTaskController.setCurrentStage(editNewStage);
            ...
            AddEditTaskController editCtrl = loader.getController();
